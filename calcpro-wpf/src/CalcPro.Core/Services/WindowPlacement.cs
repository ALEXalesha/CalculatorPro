...
/// <summary>
/// Размер и место окна между запусками (1.5.0). То же правило, что window-state.js у
/// Electron-калькуляторов: что бы ни лежало в файле - окно на отключённом мониторе,
...
{
    /// <summary>Прямоугольник в единицах WPF (DIP).</summary>
