// Размер и место окна между запусками (1.5.0). Файл одинаковый в calcpro-glass и
// ios-calculator (это проверяет test/window.test.js).
//
...
// заголовка высотой 38 (drag-зона в обоих калькуляторах) и хотя бы 80 по ширине.
